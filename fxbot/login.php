...
function wikilogin( $username, $password, $project, $useragent ) {
	...
	if ( $data['login']['result'] == "Success" ) {
		...
		//Cookie aufbauen
		$cookies = array( $data['login']['cookieprefix'] . "_session" => $data['login']['cookieprefix'] . "_session=" . $data['login']['sessionid'], $data['login']['cookieprefix'] . "UserID" => $data['login']['cookieprefix'] . "UserID=" . $data['login']['lguserid'], //   [commonswikiUserID] =>  commonswikiUserID=205395
			$data['login']['cookieprefix'] . "UserName" => $data['login']['cookieprefix'] . "UserName=" . $data['login']['lgusername'], $data['login']['cookieprefix'] . "Token" => $data['login']['cookieprefix'] . "Token=" . $data['login']['lgtoken'] );
	} else {
