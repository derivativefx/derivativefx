...
<div id="firstform" style="display:none">
	...
	<br/>
	<iframe src="http://commons.wikimedia.org/wiki/Special:Mypage"
	...
	<br style="clear:both"><?php echo $lng['x']['look']; ?> <a
		href="http://commons.wikimedia.org/w/index.php?title=Special:Userlogin"><?php echo $lng['x']['loin']; ?></a>.<br/>
...
<span id="loading" style="display:none"><table
    ...
    <iframe src="http://commons.wikimedia.org/w/index.php?action=ajax&rs=UploadForm%3A%3AajaxGetLicensePreview&rsargs[]=GFDL" id="licenceframe" width="50%" height="310" align="right"
		...
		<br/>
		<?php echo $lng['x']['lotf']; ?>: <span class="license"
												id="lic1"><?php echo $lng['x']['pan']; ?></span>
		...
		<br/>
		<br/>
		<input id="mtobut" name="morethanone" value="<?php echo $lng['x']['admo']; ?>" type="button"
			   OnClick="more()">
		<br/>

		<br/>
		<input value="<?php echo $lng['x']['next']; ?>" disabled="disabled" type="submit"
